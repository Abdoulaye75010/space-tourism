<x-layout :title="'ÉQUIPAGE | Anousheh Ansari'"
          :description="'Rencontrez notre équipage : Anousheh Ansari, ingénieur de vol.'"
          :background="[
    ...
    <section class="flex flex-col items-center text-center w-full max-w-[375px] mx-auto px-6 mt-8">
        ...
        <img src="{{ asset('images/crew/image-anousheh-ansari.png') }}" 
             alt="Ingénieur de vol Anousheh Ansari" 
        ...
        <p class="text-[15px] leading-[25px] font-barlow text-[#D0D6F9]">
            Anousheh Ansari est une ingénieure et astronaute iranienne-américaine. 
            Elle assure le bon fonctionnement des systèmes et la sécurité de l’équipage pendant la mission.
        </p>
